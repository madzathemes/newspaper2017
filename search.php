...
if ( false == get_theme_mod( 't_p_sorry_search', false ) ) { $t_p_sorry_search = esc_html__("Sorry, but nothing matched your search criteria. Please try again with some different keywords.", "newspaper2017");  } else { $t_p_sorry_search = get_theme_mod( 't_p_sorry_search' ).' %s'; }
