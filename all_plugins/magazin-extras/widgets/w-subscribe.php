...
class Subscribe_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'subscribe_widget',
			__( 'mt Subscribe', 'newspaper2017' ),
			array( 'description' =>  esc_html__( 'A Subscribe Widget', 'newspaper2017' ), )
		);
	}
	...
	public function form( $instance ) {
		$position = ! empty( $instance['position'] ) ? $instance['position'] : esc_html__( '', 'newspaper2017' );
		?>
